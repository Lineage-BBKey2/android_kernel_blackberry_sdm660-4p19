...
/*
 * Legacy ICE commands used by the BlackBerry 4.4 PFK implementation.
 */
#define BBRY_TZ_ES_SET_ICE_KEY 0x2
#define BBRY_TZ_ES_INVALIDATE_ICE_KEY 0x3

#define BBRY_TZ_ES_SET_ICE_KEY_ID \
	TZ_SYSCALL_CREATE_SMC_ID(TZ_OWNER_SIP, TZ_SVC_ES, \
				 BBRY_TZ_ES_SET_ICE_KEY)

#define BBRY_TZ_ES_INVALIDATE_ICE_KEY_ID \
	TZ_SYSCALL_CREATE_SMC_ID(TZ_OWNER_SIP, TZ_SVC_ES, \
				 BBRY_TZ_ES_INVALIDATE_ICE_KEY)

#define BBRY_TZ_ES_SET_ICE_KEY_PARAM_ID \
...
#define BBRY_TZ_ES_INVALIDATE_ICE_KEY_PARAM_ID \
